...
export function isCoreRecommendablePoi(poi) {
...
export function buildCitySignaturePool(city, candidatePool, requirement) {
...
export function checkCityCoverage(candidatePool) {
